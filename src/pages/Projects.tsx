...
const projects = [
  {
    ...
    description: "An AI-assisted interview prep tool that uses Gemini API to generate resume-tailored practice questions across HR, Technical, and DSA rounds. Includes response evaluation and automated report delivery via UiPath. Built with React and Flask.",
    tech: ["React", "Flask", "Gemini API", "UiPath"],
    image: "/lovable-uploads/portfolio-project.png",
    liveUrl: "#",
    githubUrl: "https://github.com/RemyAthisayaa17",
  },
  {
    id: 2,
    title: "Gen AI Resume JD Analyzer",
    description: "A semantic matching tool that scores how well a resume fits a job description using sentence embeddings and cosine similarity. Surfaces skill gaps and alignment scores to help candidates prepare more targeted applications. Built with Python and Flask.",
    tech: ["Python", "Flask", "NLP", "Embeddings"],
    image: "/lovable-uploads/portfolio-project.png",
    liveUrl: "#",
    githubUrl: "https://github.com/RemyAthisayaa17",
  },
